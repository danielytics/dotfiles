...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status root_indicator ssh)
POWERLEVEL9K_DIR_HOME_BACKGROUND='234' # Black
POWERLEVEL9K_DIR_HOME_FOREGROUND='082' # Green
POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='234' # Black
POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND='082' # Green
POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='196' # Dark red
POWERLEVEL9K_DIR_DEFAULT_FOREGROUND='232' # Black
POWERLEVEL9K_VCS_CLEAN_BACKGROUND='235'
POWERLEVEL9K_VCS_CLEAN_FOREGROUND='068'
POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='235'
POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='160'
POWERLEVEL9K_ROOT_INDICATOR_BACKGROUND='066'
